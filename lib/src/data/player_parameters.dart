...
import 'package:flutter_kinescope_sdk/src/data/fullscreen_fallback.dart';
...
class PlayerParameters {
  ...
  final FullscreenFallback fullscreenFallback;
  final bool? autoplay;
  ...
  const PlayerParameters({
    ...
    this.baseUrl,
    this.disableFiles,
    this.fullscreenFallback = FullscreenFallback.video,
